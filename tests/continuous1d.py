...
class TestCase(unittest.TestCase):
    ...
    def testAffineTransform(self):
        ...
        x2 = np.random.rand(5)
        y2 = t1(x2)
        np.testing.assert_allclose(scaling*x2 + offset, y2, rtol=1E-14)
        t2 = t1.inverse
        np.testing.assert_allclose(t2(y2), x2, rtol=1E-14)
        ...
        np.testing.assert_allclose(identity2.offset, 0.0)
